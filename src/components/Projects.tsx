...
const PROJ = [
  ...
  },
  {
    ...
    desc: 'Built at Zomato to replace a slow, manual weekly competitive reporting process with a live intelligence system. Tracks competitor app rankings, install trends, and keyword movements in real-time via Sensor Tower API — served automatically to 20+ stakeholders including leadership, every morning.',
    points: [
      'Sensor Tower API integration pulling real-time app store rankings and install trend data',
      'Automated daily reports delivered to 20+ stakeholders including leadership — zero manual effort',
      'Ranking shift alerts triggered automatically when a competitor moves significantly on a priority keyword',
      'Category-level benchmarking against Swiggy, Blinkit, and other food-tech competitors',
      'Historical trend analysis enabling forward-looking channel strategy decisions',
      'Built solo in ~2 weeks; eliminated a recurring 4-hour weekly manual reporting task entirely',
    ],
