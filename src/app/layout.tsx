...
export const metadata: Metadata = {
  ...
  keywords: [
    'Alok Munshi','Growth Strategist','Senior Growth Manager','Product Growth',
    'Performance Marketing','Growth Marketing Gurugram','Marketing Analyst',
    'IIT Kharagpur','Zomato','Eternal','American Express','WhatsApp Automation',
    'Builder','Cohort Analytics','LTV Modelling','A/B Testing','User Acquisition','Gurugram',
  ],
  ...
  openGraph: {
    ...
    images: [{ url: '/og-image.png', width: 1200, height: 630, alt: 'Alok Munshi — Growth Strategist & Builder' }],
  },
  twitter: {
...
const jsonLd = {
  ...
  '@graph': [
    ...
    },
    {
      ...
      description: 'Automated LinkedIn content pipeline using GitHub Actions, Claude API, Cloudflare Workers, Telegram approval, and LinkedIn API.',
      applicationCategory: 'BusinessApplication',
      author: { '@type': 'Person', name: 'Alok Munshi' },
